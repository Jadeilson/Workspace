...
import br.com.reaprender.dao.basesDao;
import br.com.reaprender.principal.Princial;
...
public class CadastroTesteOriginal {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CadastroTesteOriginal window = new CadastroTesteOriginal();
	 ...
	 * @throws SQLException 
	 */
	public CadastroTesteOriginal() throws SQLException {
		initialize();
	}
